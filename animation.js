...
function S(e,t,n){return e<t?t:n<e?n:e}
function w(e){return+(0<e)-+(e<0)}
var t={}
function A(e){return t[e]||(t[e]=e.replace(/([A-Z])/g,n))}
function n(e){return"-"+e[0].toLowerCase()}
var D=window,E=document.documentElement
function H(e,t){return e&&0!==e.length?e.nodeName?[e]:[].slice.call(e[0].nodeName?e:(t||E).querySelectorAll(e)):[]}
var L,P=function(e,t){for(var n in t)e.setAttribute("data-"+A(n),t[n])},b=[]
function x(){b.slice().forEach(function(e){return e()}),L=b.length?requestAnimationFrame(x):0}
function O(){}var W="scroll",y="resize",_="addEventListener",N="removeEventListener",T=0
